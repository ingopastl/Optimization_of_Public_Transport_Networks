...
public class PTDJMetalProblem extends AbstractDoubleProblem {
	private final TripSimulator tc;

	public PTDJMetalProblem(Itinerary itinerary, int numberOfTrips, int walkingRadius) throws IOException {
		if (numberOfTrips <= 0) {
	...
	public DoubleSolution createSolution() {
		double coef = tc.getWalkingRadius() * 0.0000089;
